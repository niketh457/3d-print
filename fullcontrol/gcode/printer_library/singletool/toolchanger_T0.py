...
def set_up(user_overrides: dict):
    ...
    ending_procedure_steps.append(ManualGcode(text='T-1 ; drop off tool'))
    ending_procedure_steps.append(ManualGcode(text='G1 X-30 Y200 F50000 ; park tool collector'))
    ending_procedure_steps.append(ManualGcode(text='M0 ; stop everything'))
